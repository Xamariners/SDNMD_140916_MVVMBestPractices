...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "ToDo", "\tIn order to manage my life efficently\r\n\tAs a disorganised monkey\r\n\tI want to str" +
        ...
        [NUnit.Framework.DescriptionAttribute("Navigate to todo list")]
        [NUnit.Framework.TestCaseAttribute("20", new string[0])]
        public virtual void NavigateToTodoList(string amount, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Navigate to todo list", exampleTags);
#line 6
